export const COMPANION_CAPABILITIES = ['knowledge', 'skills', 'mcp', 'ssh', 'git', 'companions', 'schedules', 'access', 'administration'] as const
...
export const CAPABILITY_LABELS: Record<CompanionCapability, string> = {
  knowledge: '知识库', skills: 'Skill', mcp: 'MCP', ssh: 'SSH', git: 'Git', companions: '创建伙伴',
