...
export interface PendantSettings { enabled: boolean; fps: PendantFps; material: StrapMaterial; color: string; image: string; imageFit: CardImageFit }
export const PENDANT_SETTINGS_KEY = 'dsh-partner:pendant-settings:v1'
export const DEFAULT_PENDANT_SETTINGS: Readonly<PendantSettings> = Object.freeze({ enabled: true, fps: 30, material: 'woven', color: '#617e73', image: '', imageFit: 'contain' })
...
export function samePendantSettings(a: PendantSettings, b: PendantSettings): boolean {
  return a.enabled === b.enabled && a.fps === b.fps && a.material === b.material && a.color === b.color && a.image === b.image && a.imageFit === b.imageFit
}
