...
export const BUILTIN_SKILLS = new Map<string, { entry: MarketSkillEntry; document: string }>([
  ['task-planning', {
    entry: { id: 'task-planning', name: '任务拆解与看板推进', description: '把模糊目标拆成可验收任务，安排优先级、依赖与伙伴分工。', version: '1.0.0', tags: ['任务', '看板', '协作'], skillUrl: 'builtin:task-planning', sourceId: BUILTIN_SKILL_SOURCE },
